...
const SignInModal = ({ visible, onCancel }) => {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      if (data.result) {
        ...
        setErrorMessage("Jean Claude n'a pas trouvé ton user ou ton mot de passe est peut-être incorrect.");
      }
    } catch (error) {
  ...
  return (
    <Modal open={visible} onCancel={onCancel} footer={null} closable={true} className={styles.modal} centered>
